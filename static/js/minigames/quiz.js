...
const questions = [
	{
		...
		image: './images/horror-little-girl.webp'
	},
	{
	...
	},
	{
		...
		correctAnswerIndex: 2,
		image: './images/horror-bride.webp'
	},
	{
...
function displayResult(correct) {
	...
	if (correct) {
		...
		correctAnswer.textContent = `The correct answer is: ${
			questions[currentQuestionIndex].answers[questions[currentQuestionIndex].correctAnswerIndex]
		}`;
	}
...
function handleEndQuiz() {
	 ...
	 */
	endText.textContent = 'The young man is buried under the trees next to the mansion';
	questionCard.classList.add('d-none');
	resultCard.classList.add('d-none');
	scoreCard.classList.add('d-none');
