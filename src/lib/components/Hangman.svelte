<script lang="ts">
	import { showDialogueAsync } from '/js/utils/dialogueGeneration.js?url';
	import { savePlayerData, loadPlayerData } from '/js/utils/gamedataLocalstore.js?url';
	...
	} from '/js/utils/dialogues.js?url';
	...
	onMount(() => {
		...
		const checkLetter = (letter: string, buttonElement: HTMLButtonElement) => {
		...
		const checkGameStatus = async (phrase) => {
			...
			if (gameState.incorrectGuessCount >= 6) {
				...
				gameContainer.classList.add('old-woman');
				if (loadedPlayerData.hangmanClueObtained) {
					await showDialogueAsync([{ text: `Silly child... it was clearly "${phrase}"...` }], true);
				}
		...
		const resetGame = () => {
			...
			const letterButtons = document.querySelectorAll('.ouija-board-alphabet-letter');
		...
		const runHangmanGame = async () => {
			...
			gameState.phraseArr = loadedPlayerData.hangmanClueObtained ? newClue : initialClue;
	...
	<div class="ouija-board-container">
		...
		<div class="ouija-board-alphabet">
			<div class="ouija-first-line">
				<button class="ouija-board-alphabet-letter" aria-label="A"> A </button>
				<button class="ouija-board-alphabet-letter" aria-label="B"> B </button>
				<button class="ouija-board-alphabet-letter" aria-label="C"> C </button>
				<button class="ouija-board-alphabet-letter" aria-label="D"> D </button>
				<button class="ouija-board-alphabet-letter" aria-label="E"> E </button>
				<button class="ouija-board-alphabet-letter" aria-label="F"> F </button>
				<button class="ouija-board-alphabet-letter" aria-label="G"> G </button>
				<button class="ouija-board-alphabet-letter" aria-label="H"> H </button>
				<button class="ouija-board-alphabet-letter" aria-label="I"> I </button>
				<button class="ouija-board-alphabet-letter" aria-label="J"> J </button>
				<button class="ouija-board-alphabet-letter" aria-label="K"> K </button>
				<button class="ouija-board-alphabet-letter" aria-label="L"> L </button>
				<button class="ouija-board-alphabet-letter" aria-label="M"> M </button>
			</div>
			<div class="ouija-second-line">
				<button class="ouija-board-alphabet-letter" aria-label="N"> N </button>
				<button class="ouija-board-alphabet-letter" aria-label="O"> O </button>
				<button class="ouija-board-alphabet-letter" aria-label="P"> P </button>
				<button class="ouija-board-alphabet-letter" aria-label="Q"> Q </button>
				<button class="ouija-board-alphabet-letter" aria-label="R"> R </button>
				<button class="ouija-board-alphabet-letter" aria-label="S"> S </button>
				<button class="ouija-board-alphabet-letter" aria-label="T"> T </button>
				<button class="ouija-board-alphabet-letter" aria-label="U"> U </button>
				<button class="ouija-board-alphabet-letter" aria-label="V"> V </button>
				<button class="ouija-board-alphabet-letter" aria-label="W"> W </button>
				<button class="ouija-board-alphabet-letter" aria-label="X"> X </button>
				<button class="ouija-board-alphabet-letter" aria-label="Y"> Y </button>
				<button class="ouija-board-alphabet-letter" aria-label="Z"> Z </button>
			</div>
		</div>
	</div>
</div>
